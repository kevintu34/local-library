...
const authors = [
  ...
  //Look through the books array and sum up the borrow count for each book and compile to an array
...
/*     console.log(`The total count for ${author.id} is ${count}`)
    ...
    authorSumCount.push({author: `${author.name.first} ${author.name.last}`, count: count})
  ...
  function getMostPopularBooks(books) {
    ...
    return finalResult
    return borrowListandCount
  }


/*   function filteredBooks({id}, books) { //HELPER FUNCTION
...
let userFilteredList = filteredBooks(account, books)
...
return results
console.log('**********************')
console.log(userFilteredList[0].borrows[0].id)
}

console.log(getBooksPossessedByAccount(accountA,books,authors)) */